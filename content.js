document.addEventListener('DOMContentLoaded', () => {
    ...
    const callback = () => {
      ...
      const boxOrderElement = document.querySelector('.e-boxOrder.is-showPcOnly.is-mypageRankingArticle');
      const boxOrderElement2 = document.querySelector('.e-boxOrder.is-showPcOnly.is-mypageRankingCreator');
      const boxOrderElement3 = document.querySelector('.e-boxOrder.is-mypageNewArrivalCrowdfunding.is-showPcOnly');
